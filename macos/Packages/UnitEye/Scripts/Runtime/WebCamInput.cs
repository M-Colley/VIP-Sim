...
public class WebCamInput : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (staticInput == null)
        {
            ...
            webCamTexture.requestedHeight = (int)DefaultResolution.x;
            webCamTexture.requestedWidth = (int)DefaultResolution.y;
            webCamTexture.Play();
        }
        ...
        inputRT = new RenderTexture((int)DefaultResolution.x, (int)DefaultResolution.y, 0);
    }
